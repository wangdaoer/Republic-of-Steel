...
| 118 | `ACCEPTED / CANON` | 终稿验收（路线 A 留白收束，2026-08-14）：作者选定路线 A 后重订契约（SE 84 本地、404 离线一日验证本地责任），按 §2 升级；剥离跨区网络前提，未静默继承旧 P1 |
| 119 | `ACCEPTED / CANON` | 终稿验收（路线 A，2026-08-14）：五项关系落为公共场板上的可退出准则，刻意不选 centralized 网络；旧 P1 共同框架前提已重订 |
| 120 | `ACCEPTED / CANON` | 终稿验收（路线 A，2026-08-14）：手递入口重订为本地开放旧门，北轨为本地未知设备携带者暂名；四节点网络前提已剥离，不作跨区设定 |
...
- 第 118—120 章已于 **2026-08-14 经作者选定路线 A（留白收束）后升级为 `ACCEPTED / CANON`**（见上文第 137—139 行），非静默验收；证据链与重订契约见 [`docs/volume01-closing-proposals.md`](../docs/volume01-closing-proposals.md)。
- 路线 A 选择记录：作者指令「路线 A」；ch118《工具离手的那一夜》（SE 84，404 离线一日验证本地责任）、ch119《五项关系》（SE 84—85，公共场板可退出准则，刻意不选 centralized 网络）、ch120《新的开始》（SE 85，手递入口重订为本地开放旧门）已按 §2 全文重写并回写。
- 治理文件 §3 合规要点：旧 P1 的 SE110／四节点网络／跨区任务调度／北线·南线·移动现场节点等冲突前提已全部剥离，未写入 Canon；ch118—120 由 BLOCKED 经 DECISION_GATE 显式选定后升级，台账留痕。
- 独立待办：Canon 人物 **苏烈** 全书 0 出场（内容债），记录于上述文档第 5 节，不阻塞卷收束，待 vol2—4 或外传补出场。
